export const company = {
  ...
  fullName: 'VENTURI CONSULTORIA JURÍDICA & TÉCNICA LTDA',
  shortName: 'VENTURI',
  pronunciation: 'Vênturi',
  cnpj: '63.990.379/0001-44',
  nire: '41214155181',
  ...
  addressFull: 'Rua Santos Dumont, 188 - Centro - Ponta Grossa - PR - CEP 84010-360',
  street: 'Rua Santos Dumont, 188',
  neighborhood: 'Centro',
  zipCode: '84010-360',
  city: 'Ponta Grossa',
  state: 'Paraná',
...
export const solutions = [
  ...
  },
  {
    ...
    icon: '♻️',
    longDescription: 'Assessoria técnica para sanar pendências ambientais em nível estadual e municipal. Elaboração de Planos de Recuperação de Áreas Degradadas (PRAD), Termos de Ajustamento de Conduta (TAC), processos de anistia ambiental e negociação com órgãos ambientais estaduais para desbloqueio de propriedades.',
  },
  {
    id: 'cadeia-dominial',
    title: 'Cadeia Dominial Limpa',
    slug: 'cadeia-dominial',
    icon: '🔗',
    longDescription: 'Análise completa do histórico registral do imóvel desde a origem. Identificação de falhas documentais, inconsistências de data e extensão, problemas com herança e sucessão, e elaboração de estratégia jurídica para regularização. Ideal para propriedades com histórico complexo ou dúvidas sobre legitimidade de posse.',
  },
  {
    id: 'car-sigef',
    ...
    slug: 'car-sigef',
    icon: '🗺️',
    longDescription: 'Orientação técnica especializada em Cadastro Ambiental Rural (CAR) e certificação SIGEF. Análise de conformidade, identificação de inconsistências, coordenação com profissionais habilitados e acompanhamento do processo junto ao INCRA. Essencial para propriedades acima de 4 módulos fiscais ou com pendências registrais.',
  },
];

export const methodology = [
  { step: 1, title: 'Conversa Inicial', description: 'Entendemos sua situação e coletamos documentos iniciais — gratuito e sem compromisso.' },
  { step: 2, title: 'Levantamento Técnico', description: 'Cruzamos dados do imóvel com bases oficiais (CNUC, CAR, SIGEF, SNCI).' },
  { step: 3, title: 'Diagnóstico Completo', description: 'Relatório técnico-jurídico com riscos, cenários e prazos para cada alternativa.' },
  { step: 4, title: 'Plano de Ação', description: 'Estratégia customizada com cronograma e responsáveis definidos.' },
  { step: 5, title: 'Execução e Suporte', description: 'Acompanhamento até a conclusão com relatório semanal e acesso direto ao gestor.' },
];
...
export const deliverables = [
  {
    ...
    description: 'Análise completa de toda a situação fundiária e ambiental do imóvel, com parecer de viabilidade e recomendações práticas.',
  },
  {
    id: 'mapa-tecnico',
    title: 'Mapa Técnico Georreferenciado',
    description: 'Mapa preciso com todas as sobreposições, restrições e limites identificados — pronto para apresentação em órgãos.',
  },
  {
    id: 'parecer-juridico',
    title: 'Parecer Jurídico Fundamentado',
    description: 'Opinião técnica sobre direitos adquiridos, viabilidade de regularização e estratégias legais disponíveis.',
  },
  {
    id: 'dossie-administrativo',
    title: 'Dossiê Administrativo Organizado',
    description: 'Compilação de toda a documentação necessária — pronta para protocolos em órgãos federais e estaduais.',
  },
  {
    id: 'cronograma-prazos',
    title: 'Cronograma de Prazos Realistas',
    description: 'Timeline detalhada de cada etapa da regularização com responsáveis definidos.',
  },
];
...
export const faq = [
  {
    question: 'Qual é o diferencial da Venturi?',
    answer: 'Combinamos expertise em direito ambiental, direito registral e georreferenciamento com análise de dados de bases oficiais (CNUC, CAR, SIGEF, SNCI). Não é consultoria de escritório — é campo com rigor técnico. Atuamos em casos que outros profissionais consideram inviáveis.',
  },
  {
    question: 'Quanto tempo leva para resolver um problema fundiário?',
    answer: 'Depende da situação. Um diagnóstico simples leva 10-15 dias. Uma regularização completa com negociação junto a órgãos ambientais pode levar 60-180 dias. Damos sempre um cronograma realista no primeiro encontro.',
  },
  {
    question: 'Trabalham com imóvel em quanto estados?',
    answer: '100% remoto. Atuamos em todo o Brasil, com equipes que entendem as peculiaridades regulatórias de cada estado — IC do Centro-Oeste, lógica das UCs do Amazonas, legislação estadual ambiental em SP, MG e RS.',
  },
  {
