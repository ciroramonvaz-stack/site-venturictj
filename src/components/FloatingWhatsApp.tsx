...
export function FloatingWhatsApp() {
  ...
  return (
    <button
      ...
      className="fixed bottom-6 right-6 z-50 rounded-full bg-[#25D366] p-4 text-white shadow-lg shadow-green-500/30 transition hover:scale-110 hover:shadow-green-500/50 cursor-pointer"
    >
