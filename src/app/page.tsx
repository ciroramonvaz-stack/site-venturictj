...
index 3efc0f46b3d655329c77cfdbd06042918ce00c8f..083ea7b37c6eb5d9b5b5b7db422494092bf1320d 100644
--- a/src/app/page.tsx
+++ b/src/app/page.tsx
@@ -1,516 +1,114 @@
...
-  };
+  const { company, heroImages } = siteData;
+
+  const sections = [
+    {
+      title: 'Soluções',
+      description:
+        'Entenda, em linguagem simples, como tratamos sobreposição com UC, regularização fundiária e ambiental, dívidas rurais e créditos de carbono.',
+      href: '/solucoes',
+      status: 'Disponível',
+    },
+    {
+      title: 'Resultados',
+      description:
+        'Casos reais com contexto, limite da atuação e evidências do que foi entregue para dar credibilidade e transparência.',
+      href: '/resultados',
+      status: 'Disponível',
+    },
+    {
+      title: 'Quem Somos',
+      description:
+        'Conheça os sócios, especialidades e histórico profissional da equipe que conduz cada caso.',
+      href: '/sobre',
+      status: 'Disponível',
+    },
+    {
+      title: 'Contato',
+      description:
+        'Canal direto para análise inicial e definição da melhor estratégia para o seu imóvel rural.',
+      href: '/contato',
+      status: 'Disponível',
+    },
+  ];
...
-              </p>
+    <main className="bg-black text-white">
+      <section className="relative min-h-[78vh] overflow-hidden flex items-center border-b border-white/10">
+        <Image
+          src={heroImages[0]}
+          alt="Imóvel rural brasileiro"
+          fill
...
+            <div className="gold-kicker mb-6">Home</div>
+            <h1 className="font-serif text-5xl md:text-7xl font-bold leading-tight mb-6">
+              Venturi: visão clara para decisões seguras no seu imóvel rural.
+            </h1>
+            <p className="text-lg md:text-xl text-white/75 max-w-3xl leading-relaxed mb-10">
+              Esta página agora é exclusivamente a Home. Aqui você encontra uma visão geral e acessa cada aba específica, sem depender de rolagem longa em página única.
+            </p>
+
...
+                className="inline-flex items-center justify-center px-8 py-4 border border-white/25 text-white font-semibold rounded-lg hover:border-venturi-gold hover:text-venturi-gold transition-colors duration-300"
               >
...
+            <div className="gold-kicker mb-3">Navegação Estruturada</div>
+            <h2 className="font-serif text-4xl md:text-5xl font-bold mb-4">
+              As próximas abas já estão organizadas
+            </h2>
+            <p className="text-white/65 text-lg">
+              Cada tema foi separado em uma página própria para facilitar leitura, gerar mais confiança e melhorar a experiência de decisão.
+            </p>
           </div>
-        </section>
-
...
+                key={section.title}
+                href={section.href}
+                className="premium-card rounded-2xl p-8 hover:border-venturi-gold/30 transition-colors duration-300"
               >
-                Conheça o time completo →
+                <span className="text-xs uppercase tracking-[0.2em] text-venturi-gold/70">{section.status}</span>
+                <h3 className="font-serif text-3xl mt-3 mb-4">{section.title}</h3>
+                <p className="text-white/65 leading-relaxed">{section.description}</p>
+                <span className="inline-flex mt-6 text-venturi-gold font-semibold">Acessar aba →</span>
               </Link>
-            </div>
-          </div>
-        </section>
